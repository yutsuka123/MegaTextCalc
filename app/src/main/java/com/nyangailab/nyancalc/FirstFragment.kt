...
import com.nyangailab.nyancalc.databinding.FragmentFirstBinding
    ...
    private fun setupEqualButton() {
        ...
        binding.btnEqual.setOnClickListener {
            if (currentInput.isNotEmpty() && operator.isNotEmpty()) {
                ...
                SoundPlayer.playAsset(requireContext(), "equal.mp3", onCompletion = {
                    SoundPlayer.playAsset(requireContext(), SoundPlayer.getRandomCatSound(requireContext()), onCompletion = {
